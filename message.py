...
def writeScore(score, speed) :
    myfont = pygame.font.Font('C:\우주 괴물 무찌르기/NanumGothic.ttf', 20)  
    txt = myfont.render(u'파괴한 우주괴물 수 : ' + str(score), True, (255-r, 255-g, 255-b))
    monitor.blit(txt, (10, sheight - 70))   
    txt2 = myfont.render(u'우주괴물의 속도' + str(speed), True, (255-r, 255-g, 255-b))
    monitor.blit(txt2, (10, sheight - 40))   

async def playGame() :
    global monitor, ship, monster, missile, missileSpeed, myfont
    ...
    while True :
        ...
        if displaycheck == 1:
            myfont = pygame.font.Font('C:\우주 괴물 무찌르기/NanumGothic.ttf', 20)  
            txt3 = myfont.render(u'점수가 부족합니다!', True, (255-r, 255-g, 255-b))
            monitor.blit(txt3, (250, 350))   
        ...
        writeScore(fireCount, monsterSpeed)
...
monsterImage = ['C:\우주 괴물 무찌르기/monster01.png', 'C:\우주 괴물 무찌르기/monster02.png', 'C:\우주 괴물 무찌르기/monster03.png', 'C:\우주 괴물 무찌르기/monster04.png', \
                'C:\우주 괴물 무찌르기/monster05.png', 'C:\우주 괴물 무찌르기/monster06.png', 'C:\우주 괴물 무찌르기/monster07.png', 'C:\우주 괴물 무찌르기/monster08.png', \
                'C:\우주 괴물 무찌르기/monster09.png', 'C:\우주 괴물 무찌르기/monster10.png']
monster = None   # 우주괴물
...
ship = pygame.image.load('C:\우주 괴물 무찌르기/ship02.png')
shipSize = ship.get_rect().size

# @기능 4-1 : 미사일 이미지를 추가한다.
missile = pygame.image.load('C:\우주 괴물 무찌르기/missile.png')
